<template>
    <div
        class="border-dashed lg:border-solid border-[#000000] border-t lg:border-t-0 lg:border-l p-5 flex flex-1 flex-col gap-[30px] items-start justify-start shrink-0  min-w-[350px] relative overflow-hidden">

        <template
            v-for="{ client, invoiceNumber, issueDate, product, provider, additionalInfo, dueDate, paymentTerms, } of [exampleInvoice]"
            :key="1112123">
            <!-- topHeading -->
            <div class="flex flex-row gap-[25px] items-start justify-start flex-wrap self-stretch shrink-0 relative">
            ...
            <div class="flex flex-col gap-2.5 items-start justify-start shrink-0 relative">
                <div class="flex flex-row gap-[15px] items-start justify-start shrink-0 w-[205px] relative">
                    ...
                    <div class="text-[#000000] text-left relative flex-1"
                ...
                <div class="flex flex-row gap-[15px] items-start justify-start shrink-0 relative">
                    ...
                    <div class="shrink-0 w-full flex flex-col gap-1 items-start justify-start">
                        <p class="text-[#000000] text-left" style="font: 400 14px/100% 'Product Sans', sans-serif">
                            {{ client.name }}
                        </p>
                        <p class="text-[#000000] text-left" style="font: 400 14px/100% 'Product Sans', sans-serif">
                            {{ client.address }}
                        ...
                        <p class="text-[#000000] text-left" style="font: 400 14px/100% 'Product Sans', sans-serif">
                            <span style="font: 700 14px/100% 'Product Sans', sans-serif">TAX ID:</span> {{ client.taxID }}
                        </p>
            ...
            <div class="pt-[25px] pb-[25px] flex flex-col items-start justify-between self-stretch flex-1 relative">
                ...
                <template v-for="{ description, subtotal, timeOfHiring } in product.items" :key="description">
                    <PreviewItems :description="description" :subtotal="subtotal" :timeOfHiring="timeOfHiring" />
                </template>
                ...
                <div
                    ...
                    <div class="flex flex-row items-start justify-between self-stretch shrink-0 relative">
                        ...
                        <div class="text-[#363636] text-left relative" style="font: 700 14px 'Product Sans', sans-serif">
                            {{ new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(product.total)
                            }}
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="flex flex-col gap-0 items-start justify-start shrink-0 relative">
                        <div class="text-[#000000] text-left relative w-[415px]"
                ...
                <div class="text-[#363636] text-left relative self-stretch"
                    ...
                    Please ensure that you include the invoice number in the transaction description
                    to facilitate accurate payment processing. Kindly make the payment within the
                    specified due date.<br />For any payment-related inquiries, feel free to contact
                    our finance department at finance@yourcompany.com or call +1-123-456-7890.<br />Thank
...
const { userData } = userDetailsInvoices()
