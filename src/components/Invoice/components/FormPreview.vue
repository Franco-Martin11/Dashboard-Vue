<template>
  <div
    ...
    <template v-for="{ client, invoiceNumber, issueDate, product, provider, dueDate } of [useDataEmpty]"
      :key="invoiceNumber">
      <!-- topHeading -->
      ...
      <div class="pt-[25px] pb-[25px] flex flex-col items-start justify-between self-stretch flex-1 relative">
        ...
        <div
          ...
          <svg class="shrink-0 relative overflow-visible" style="" width="92" height="68" viewBox="0 0 92 68" fill="none"
