<template>
  <div class="rounded-[30px] bg-Pallet-Purple w-[276px] h-[632px] p-6 flex flex-col justify-between items-center relative overflow-hidden shrink-0">
    <div class="flex justify-between w-full">
      <h4 class="text-[#fff] font-heading-bold text-[16px]">Campaign Earning</h4>
      <div class="relative">
        <div class="w-[221px] h-[221px] rounded-full bg-[#fff] opacity-[0.30] absolute top-[-9rem] left-[-2rem] z-10" />
        <button class="w-[48px] h-[48px] bg-transparent cursor-pointer z-20 relative flex items-center justify-end" type="button" @click="console.log('prueba')">
          <KebabOption />
        </button>
      </div>
    </div>
    ...
    <div class="bg-[#EA5A47] rounded-[10px] w-[222px] h-[107px]">
      <div class="flex flex-col gap-2 justify-start bg-card-pattern w-full h-full p-4 text-[#fff] relative">
        ...
        <button class="self-end text-[9px] font-body-regular absolute right-[15px] bottom-[7px]" type="button">
          Upgrade Now!
        </button>
      </div>
    </div>
